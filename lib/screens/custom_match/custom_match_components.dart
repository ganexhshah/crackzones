            ...
            children: [
              Row(
                children: [
                  Container(
                    ...
                    child: (match.gameName.toLowerCase().contains('free fire'))
                        ? Image.asset(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${match.roomType == 'LONE_WOLF' ? 'Lone Wolf' : 'Custom Room'} | ${match.matchType} | by ${match.creatorName}',
                          style: TextStyle(
                            color: Colors.grey[700],
                            fontSize: 12,
                            fontWeight: FontWeight.w600,
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 10),
                  _meta('Prize Pool', 'Rs ${match.prizePool.toStringAsFixed(0)}'),
                ],
              ),
              const SizedBox(height: 8),
              Row(
                children: [
                  _meta('Rounds', '${match.rounds}'),
                  const SizedBox(width: 10),
                  _meta('Default Coin', '${match.defaultCoin}'),
                ],
              ),
              const SizedBox(height: 10),
              Text(
              ...
              Wrap(
                ...
                children: [
                  _rulePill(
                    ...
                    label: 'Throwable',
                    enabled: match.throwableLimit,
                  ),
                  _rulePill(
                    icon: Icons.auto_fix_high_rounded,
                    label: match.characterSkill
                        ? (match.allSkillsAllowed
                              ? 'All Characters'
                              : '${match.selectedSkills.length} Characters')
                        : 'No Character Skills',
                    enabled: match.characterSkill,
                  ),
                  _rulePill(
                    icon: Icons.gps_fixed_rounded,
                    label: match.headshotOnly ? 'Headshot Only' : 'Normal Aim',
                    enabled: match.headshotOnly,
                  ),
                  _rulePill(
                    icon: Icons.tune_rounded,
                    label: 'Gun Attributes',
                    enabled: match.gunAttributes,
                  ),
                ],
              ),
